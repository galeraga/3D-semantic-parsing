...
We are implementing the [PointNet](https://arxiv.org/abs/1612.00593?context=cs) architecture provides a unified deep learning architecture for the following recognition tasks, based on point cloud inputs:
