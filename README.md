...
The T-Net is a network that estimates a affine transformation matrix. Given two affine spaces A1 and A2, an affine transformation, also called affinity, is a morphism between A1 and A2 such that the induced map f_P between the Euclidean spaces E1 and E2 and with the point P in A1 is a linear map.
